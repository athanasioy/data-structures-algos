...
Answer:
The recursive method uses O(n) space, because each
recursive call creates a stack frame to store
references to e,next_pos and the return address.

The while loop is O(1) since the space used is constant
and invariant of the size of the list.
"""
